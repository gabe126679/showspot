    ...
    if (shows) {
      shows.map((show) => {
        show.backlines.map((backline) => {
          if (backline.artist === auth.uid && !checkedBacklines.includes(show.id)) {
            setCheckedBacklines([...checkedBacklines, show.id]);
          }
        })
      })
    }
                          ...
                          <td className="backlines">
                                ...
                                <Dropdown >
                                  ...
                                  {show.backlines && show.backlines.map((backline) => {
                                    return (
                                        <Dropdown.Item className="w-300" href="#/action-1">  
                                          <div className="backlineColumn">
                                            <Link to={"/artist/" + backline.artist}>
                                              {backline.firstName + " " + backline.lastName}
                                              
                                            </Link>
                                            <button className="btn-sm btn-primary float-end">^</button>
                                          </div>
