...
function Invites(props) {
    ...
    const BandDecision = (band, artist, decision) => {
        ...
        if (count === band.members.length) {
            props.activateBand(band, true);
            // setCount(0);
            
        } else if (count < band.members.length) {
                                            ...
                                            <tr>
                                                ...
                                                <td ><button className="btn btn-warning" id={band.id} onClick={() => {
                                                    ...
                                                    band.members.map((secondMember) => {
                                                        if (secondMember.accepted === true && count <= band.members.length) {
                                                            setCount(count + 1);    
                                                            console.log(count);               
                                                        }
                                                    })
                                        ...
                                        return (
                                            <tr>
                                                ...
                                                <td id={band.id}><button className="btn btn-warning" id={band.id} onClick={() => {
                                                    ...
                                                    band.members.map((secondMember) => {
                                                        const points = [...band.members];
                                                        const demo = points.sort(function(a, b){ return a.accepted === true -b.accepted === false});
                                                        console.log(demo);
                                                        if (secondMember.accepted) {
                                                            setCount(count + 1); 
