...
function Tickets(props) {
    ...
    const handleBacklineVote = (show, artist) => {

        show.backlines.map((backline) => {
            if (backline.artist === artist) {
                const backlineObject = {
                    title: show.id,
                    artist: artist,
                    voter: auth.uid                    
                            ...
                            <Container fluid>
                                ...
                                <Table bordered hover>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button className={"btn btn-primary"} onClick={handleBacklineVote(show.id, backline.artist)}>+</button> 
                                        </td>
                                    </tr>
                                    </tbody>
                                        )
