...
function Invites(props) {
    ...
    const handleAccept = (e) => {
        ...
        shows.map((show) => {
            console.log(show)
            if (e.target.id === show.headlinerId) {
                props.updateHeadliner(true);
            } else if (e.target.id === show.fourthId) {
                props.updateFourth(true);
            } else if (e.target.id === show.thirdId) {
                props.updateThird(true);
            } else if (e.target.id === show.secondId) {
                props.updateSecond(true);
            } else if (e.target.id === show.openerId) {
                props.updateOpener(true);
            } else if (e.target.id === show.venueId) {
