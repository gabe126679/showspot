                ...
                {shows && shows.map((show) => {
                    if (
                        ...
                        return (
                            <tr>
                                <td id={show.id}><button className="btn btn-warning" id={show.id} onClick={ViewShow}>{show.id}</button></td>
                                <td id={show.id} onClick={handleReject}>Accept</td>
                                <td ><button className="btn btn-warning" id={show.id}>Show Rejecetd</button></td>
                                <td>headliner</td>
                            </tr>
                        ) 
                    } else if (
                        ...
                        return (
                            <tr>
                                <td id={show.id}><button className="btn btn-warning" id={show.id} onClick={ViewShow}>{show.id}</button></td>
                                <td id={show.id} onClick={handleAccept}>Accept</td>
                                <td ><button className="btn btn-warning" id={show.id}>Show Rejecetd</button></td>
                                <td>fourth</td>
                            </tr>
                        ) 
