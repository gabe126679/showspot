              ...
              if (user.id === id) {
                return (
                  <div className="profile-border">
                    <br/>
                    <div>
                        <button className="btn btn-primary addToCart" onClick={pushArtists}>
                            Become an Artist
                        </button>
                        ...
                        return (
                          <tbody>
                            ...
                            <tr>
                              <td>{song.title}</td>
                              <td>{song.price}</td>
                              <td className=" text-center"><button className="addToCart btn btn-primary" onClick={addToCart} id={song.song}>+</button></td>
                            </tr>
                          </tbody>
                        )
