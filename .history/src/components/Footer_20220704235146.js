...
function Footer(props) {
  ...
  const [songs, setSongs] = useState([
    {
      ...
      src: "https://firebasestorage.googleapis.com/v0/b/dream-project-1040a.appspot.com/o/songs%2F1.%20Carrie%20Morris.mp3?alt=media&token=6465c382-db77-48c5-8c69-824f93b6a04c"
    },
    {
      title: "Song 2",
      artist: "Artist 2",
  ...
  useEffect(() => {
    ...
    const getFromFirebase = () => {
      //1.
      const imagesRef = ref(storageRef, 'songs');

      imagesRef.get().then(function (res) {
          //3.
