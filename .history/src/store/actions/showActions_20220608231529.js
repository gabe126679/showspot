...
export const updateHeadliner = (headliner) => {
  return async (dispatch, getState, { getFirestore }) => {
      ...
      firestore.collection('shows').doc(headliner.title).set({
          headlinerDecision: headliner.headlinerDecision,
      }).then(() => {
...
export const updateFourth = (fourth) => {
  return async (dispatch, getState, { getFirestore }) => {
      ...
      firestore.collection('shows').doc(fourth.title).set({
          openerDecision: fourth.openerDecision
      }).then(() => {
...
export const updateThird = (third) => {
  return async (dispatch, getState, { getFirestore }) => {
      ...
      firestore.collection('shows').doc(third.title).set({
          thirdDecision: third.thirdDecision,
      }).then(() => {
...
export const updateSecond = (second) => {
  return async (dispatch, getState, { getFirestore }) => {
      ...
      firestore.collection('shows').doc(second.title).set({
          secondDecision: second.secondDecision,
      }).then(() => {
...
export const updateOpener = (opener) => {
  return async (dispatch, getState, { getFirestore }) => {
      ...
      firestore.collection('shows').doc(opener.title).set({
          openerDecision: opener.openerDecision
      }).then(() => {
...
export const updateVenue = (venue) => {
  return async (dispatch, getState, { getFirestore }) => {
      ...
      firestore.collection('shows').doc(venue.title).set({
