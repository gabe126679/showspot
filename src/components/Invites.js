...
function Invites(props) {
    ...
    const handleAccept = (e) => {
        ...
        shows.map((show) => {
            if (show.id === e.target.id && show.headlinerId === auth.uid && show.headlinerDecision !== false) {
                setHeadlinerDecision(true);
            }
            if (show.id === e.target.id && show.fourthId === auth.uid && show.fourthDecision !== false) {
                setFourthDecision(true);
            }
            if (show.id === e.target.id && show.thirdId === auth.uid && show.thirdDecision !== false) {
                setThirdDecision(true);
            }
            if (show.id === e.target.id && show.secondId === auth.uid && show.secondDecision !== false) {
                setSecondDecision(true);
            }
            if (show.id === e.target.id && show.openerId === auth.uid && show.openerDecision !== false) {
                setOpenerDecision(true);
            }
            if (show.id === e.target.id && show.venueId === auth.uid && show.venueDecision !== false) {
                setVenueDecision(true);
            }
                      ...
                      <tbody>                      
                        {shows && shows.map((show) => {
                            if (
                                ...
                                return (
                                    <tr>
                                        <td id={show.id}><button className="btn btn-warning" id={show.id} onClick={ViewShow}>View Show</button></td>
                                ...
                                return (
                                    <tr>
                                        <td><button className="btn btn-warning" id={show.id} onClick={ViewShow}>View Show</button></td>
